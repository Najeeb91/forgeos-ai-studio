...
export async function runMigrations(pool) {
  ...
  const files = ["001_baseline.sql", "002_memory_and_provider.sql", "003_portable_storage_and_source_sync.sql", "004_deployment_run_binding.sql", "005_source_run_binding.sql"];
